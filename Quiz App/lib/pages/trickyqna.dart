...
import 'package:quiz_world/qna/trickyqna.dart';

class TrickyQNA extends StatefulWidget {
  @override
  _TrickyQNAState createState() => _TrickyQNAState();
}

class _TrickyQNAState extends State<TrickyQNA> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Best 10 Tricky Questions'),
        elevation: 0.0,
