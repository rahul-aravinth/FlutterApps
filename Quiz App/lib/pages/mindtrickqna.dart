...
import 'package:quiz_world/qna/mindtrickqna.dart';


class MindTrickQNA extends StatefulWidget {
  @override
  _MindTrickQNAState createState() => _MindTrickQNAState();
}

class _MindTrickQNAState extends State<MindTrickQNA> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Best 10 Mind Trick Questions'),
        elevation: 0.0,
